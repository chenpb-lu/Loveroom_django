# -*- coding: utf-8 -*-
# Generated by Django 1.11.22 on 2019-08-04 10:27
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avator_sor', models.ImageField(default='avator/default.jpg', upload_to='avator/', verbose_name='头像')),
                ('ID_num', models.CharField(max_length=18, verbose_name='身份证号')),
                ('sex', models.IntegerField(choices=[(0, '男'), (1, '女'), (None, '保密')], default=None, verbose_name='性别')),
